...
module.exports = {
  ...
  run: function () {
    var _run = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(client, interaction) {
      var command, customId, roleId, role, hasRole;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 16:
            _context.next = 18;
            return interaction.editReply("Tu rol ".concat(role, " ha sido eliminado"));
          case 18:
          ...
          case 22:
            _context.next = 24;
            return interaction.editReply("El rol ".concat(role, " ha sido a\xF1adido"));
          case 24:
            return _context.abrupt("return", _context.sent);
          case 27:
            _context.prev = 27;
          ...
          case 33:
            ...
            if (command) {
              ...
              interaction.reply({
                content: 'El comando no existe o está desactivado'
              });
            }
          case 34:
          case "end":
